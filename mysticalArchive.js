...
const spellBook ={
    ...
    SnakeskinVeil: {
        ...
        cost: "No",
        spellText: "You call on nautral forces to shed damage from your body and shield you from future attacks. You regan hit points equal to 1d8 + your spellcasting ability modifier, untill your next turn ranged spell attacks agianst you gain disadvantage.",
        atHigherLevel: "",
        imageUrl: "snakeskinVeil",
        imageDiscription: "An sylvan man sheding skin while mebraced by two snakes",
    },
    UrzasRage: {
        ...
        atHigherLevel: "<strong>At Higher Levels.</strong> You may cast this spell at 8th level, if you do the damage is 15d10 fire damage on hit and ingore any fire resistance or immuinty the target has, this spell also cannot be countered. (You can only cast this at level 3 or 8)",
        imageUrl: "urzasRage",
    ...
    CompulsiveResearch: {
        ...
        cost: "No",
        spellText: "You call upon the desparation of students past to study your ass off. For the spell's duration you can read or study all night with out suffering exhaustion damage. You also gain advatage on one of either invesgation, arcane, history, nature orreligion. You will not however, gain any of the beniefts on a long rest, such as healing, regaining spell slots or abilites.",
        atHigherLevel: "",
    ...
    StoneRain: {
        ...
        cost: "No",
        spellText: "You channel stone rain from the heavens. Each creature in a 20-foot-radius cylinder must make a Dexterity saving throw. A target takes 6d6 bludgeoning damage on a failed save, or half as much damage on a successful one. The targeted area then becomes rough terran for the spell's duration",
        atHigherLevel: "<strong>At Higher Levels.</strong> When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.",
        imageUrl: "stoneRain",
    ...
    name: "Infuriate",
        ...
        components: "V, S",
        cost: "No",
        spellText: "You touch a willing creature and channel pure anger into it. Until the start of your next round the target has advamtage on melee attacks rolls it makes and any creature making melee attack against also gains advantage.",
        atHigherLevel: "",
        imageUrl: "infuriate",
    ...
    SignInBlood: {
        ...
        cost: "No",
        spellText: "You sign your name in blood sigil on a surface or peice of paper. The first creature that reads must make a wisdom saving throw. On a failure they take 8d6 damage. The creature that first read the sigil now knows you name, location at time of reading, how long it as been since you cast the spell and your likeness (this can be used for scrying purposes).",
